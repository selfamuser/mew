...
function Home() {
  ...
  return (
    <div className='bg-gray-800 min-h-screen'>
      <div className="relative overflow-hidden h-screen flex flex-col md:flex-row">
        {/* Image Container */}
        <div className="relative w-full md:w-1/2 flex justify-center items-center bg-gray-800">
        ...
        {/* Content */}
        <div className="relative w-full md:w-1/2 flex flex-col justify-center items-center bg-gray-800 text-white z-20 p-8 md:p-16">
